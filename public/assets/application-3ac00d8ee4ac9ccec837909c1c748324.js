...
(function() {
  ...
  ready = function() {
    $('a.comment-link').on('click', function(e) {
      ...
      return $(this).removeClass('comment-link').addClass('disabled');
    });
    $('.hide-comments').on('click', function() {
      $(this).siblings('.comments').slideToggle();
      return $(this).children('i').toggleClass('icon-chevron-right icon-chevron-down');
    });
    $('.comment').on('mouseover', function() {
      return $(this).addClass('highlight');
    });
    return $('.comment').on('mouseout', function() {
